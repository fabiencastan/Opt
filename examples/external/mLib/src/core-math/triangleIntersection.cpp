...
{
    return (NoDivTriTriIsect(t0v0.array, t0v1.array, t0v2.array, t1v0.array, t1v1.array, t1v2.array) == 1);
}

bool triangleIntersectTriangle(const ml::vec3f t0[3], const ml::vec3f t1[3])
{
    return (NoDivTriTriIsect(t0[0].array, t0[1].array, t0[2].array, t1[0].array, t1[1].array, t1[2].array) == 1);
}
